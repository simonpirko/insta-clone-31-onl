                                ...
                                <div class="row row-cols-auto">
                                    <div class="col align-self-start">
                                        <a class="btn btn-outline-secondary btn-lg"
                                           href="${pageContext.request.contextPath}/post?userId=${profileUser.getId()}"
                                           role="button">Публикации</a>
                                    </div>
                                    <div class="col align-self-between">
                                        <a href='<%=friendLink%>' type="button"
                                    ...
                                    <div class="col align-self-between">
                                        <c:if test="${isOwner }">
                                            <a href="#" class="btn btn-outline-secondary" data-bs-toggle="modal"
                                               data-bs-target="#myRequestToFriendshipModal">
                                            ...
                                            <div class="modal fade" id="myRequestToFriendshipModal" tabindex="-1"
                                                 aria-labelledby="myRequestToFriendshipModalLabel"
                                                 aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="myRequestToFriendshipModalLabel">Мои заявки</h5>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-1">
                                                                        <c:if test="${myRequest.photos().size() != 0}">
                                                                            <img src="${myRequest.photos().getLast()}"
                                        ...
                                        <c:if test="${!isOwner}">
                                            <form method="post" action="${pageContext.request.contextPath}/friends">
                                                ...
                                                <c:if test="<%=!isFriendOrSendRequest%>">
                                                    <button class="btn btn-outline-secondary btn-lg" type="submit">В
                                                        друзья
                                                    </button>
                                                </c:if>
                                                <c:if test="<%=isFriendOrSendRequest%>">
                                                    <button class="btn btn-outline-secondary btn-lg"
                                                            disabled>${underСonsideration ? "На рассмотрении":"В друзьях"}</button>
                                                </c:if>
                                            </form>
                                        </c:if>
                                    </div>
                                    <div class="col align-self-end">
                                        <c:if test="${isOwner }">
                                            <a href="#" class="btn btn-outline-secondary" data-bs-toggle="modal"
                                               data-bs-target="#requestToFriendshipModal">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                     fill="currentColor"
                                                     class="bi" viewBox="0 0 16 16">
                                                    <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"></path>
                                            ...
                                            <div class="modal fade" id="requestToFriendshipModal" tabindex="-1"
                                                 aria-labelledby="requestToFriendshipModalLabel"
                                                 aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="requestToFriendshipModalLabel">
                                                                Заявки в друзья</h5>
                                                            <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal"
                                                                    aria-label="Close"></button>
