...
import by.tms.instaclone31onl.core.models.dto.Ticket;
import by.tms.instaclone31onl.core.models.response.InstaResponse;
...
public class HttpApiServlet extends HttpServlet {
    ...
    protected Ticket permission = null;
    ...
    private void setPermission(HttpServletRequest req){
        String ticket = (String)req.getAttribute("ticket");
        if(ticket == null){
            return;
        }
        permission = JsonConverter.deserialize(ticket, Ticket.class);
    }
